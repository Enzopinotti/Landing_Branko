...
export interface CmsTreatment extends CmsBaseRecord { treatment_id:string; slug:string; title:string; subtitle:string; description:string; tag:string; icon_key:string; sort_order:number|string }
...
export interface CmsMedia extends CmsBaseRecord { media_id:string; file_name:string; mime_type:string; file_size:number|string; public_url:string; alt_text:string }

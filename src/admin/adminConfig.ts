...
export const collectionDefinitions: Record<CmsCollectionKey, CollectionDefinition> = {
  ...
  locations: { key:'locations',title:'Ubicaciones',singular:'ubicación',description:'Consultorios y puntos de atención mostrados en contacto.',idField:'location_id',primaryField:'city',secondaryField:'name',fields:[{key:'city',label:'Ciudad',required:true,placeholder:'Ej. Ensenada'},{key:'name',label:'Nombre del lugar',placeholder:'Ej. Consultorio principal'},{key:'address',label:'Dirección',required:true,span:2},{key:'secondary_text',label:'Texto secundario',span:2,placeholder:'Ej. entre Cestino y Alberdi'},{key:'external_url',label:'Enlace externo',kind:'url',span:2,placeholder:'https://...'},sortField,statusField] },
...
export const navGroups:Array<{label:string;items:Array<{id:AdminView;label:string;description:string}>}>=[
  {label:'Panel',items:[{id:'overview',label:'Resumen',description:'Estado general'},{id:'general',label:'Datos generales',description:'Contacto y métricas'},{id:'content',label:'Textos',description:'Copy de la landing'}]},
